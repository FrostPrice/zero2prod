...
impl SubscriberName {
    ...
    // * Expose the inner value of `SubscriberName` as an imutable reference.
    ...
    //     &self.0
    // }
    // * Expose the inner value of `SubscriberName` as an mutable reference.
    ...
    // * Expose the inner value of `SubscriberName` by consuming the struct itself
